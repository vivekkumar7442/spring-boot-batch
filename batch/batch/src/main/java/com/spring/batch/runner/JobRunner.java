...
import com.spring.batch.constant.Constants;
...
public class JobRunner {
	...
	public void runBatchJob() {
		...
		jobParametersBuilder.addString(Constants.FILE_NAME_CONTEXT_KEY,
				"D:\\spring-batch\\batch\\batch\\src\\main\\resources\\application.properties");
		jobParametersBuilder.addDate("date", new Date(), true);
		runJob(dataTransfer, jobParametersBuilder.toJobParameters());
	}
